...
public class CopyOfTabTheoLoaiSpActivity extends ActivityGroup {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        utils = new Utils(CopyOfTabTheoLoaiSpActivity.this);
        db = new EcommerceDatabase(CopyOfTabTheoLoaiSpActivity.this);
        ...
        titleSearch = "";
        nameSearch = "";
        catSearch = getIntent().getStringExtra("TenLoaiSp");
	...
	protected void onStart() {
		...
		lvProducts.setOnItemLongClickListener(new OnItemLongClickListener(){
			public boolean onItemLongClick(AdapterView<?> arg0, View view, final int position, long arg3) {
				LayoutInflater inflater = (LayoutInflater)CopyOfTabTheoLoaiSpActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		...
		btnRegister.setOnClickListener(new OnClickListener(){
			public void onClick(View view){
				dialog = new MyAlertDialog(CopyOfTabTheoLoaiSpActivity.this);
...
//			long sqliteSize = db.size(EcommerceDatabase.TABLE_PRODUCTS);
    ...
    private class PromotionAdapter extends BaseAdapter{
    	...
    	public PromotionAdapter(ArrayList<String> ll){
    		inflater = (LayoutInflater)CopyOfTabTheoLoaiSpActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    		list = ll;
    	}
